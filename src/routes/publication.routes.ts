...
import { createPublicationController, deletePublicationController, getAllPublicationsController, getAllPublicationsPaginatedController, getFollowingPublicationsController, getFollowingPublicationsControllerPaginated, getNonFollowingPublicationsController, getOnePublicationController, getPublicationsOfUser, getUserCommunitiesPublications, updatePublicationController } from "@controllers/publication.controller";
...
router
    ...
    .get('/:communityShortname?', getAllPublicationsPaginatedController)
